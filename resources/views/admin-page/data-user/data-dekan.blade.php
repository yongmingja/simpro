...
<nav aria-label="breadcrumb mb-0">
    <ol class="breadcrumb breadcrumb-style2">
      ...
      <li class="breadcrumb-item">
        <a href="{{route('data-user-dekan.index')}}">@yield('title')</a>
      </li>
            ...
            <div class="col-12">
                <div class="card table-responsive">
                    <div class="card-body">
                        ...
                        <!-- AKHIR TOMBOL -->
                            <table class="table table-hover table-responsive" id="table_dekan">
                              <thead>
                                <tr>
                                  <th>#</th>
                                  <th>Name</th>
...
<script>
    ...
    // DATATABLE
    $(document).ready(function () {
        var table = $('#table_dekan').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('data-user-dekan.index') }}",
            columns: [
        ...
        $("#form-tambah-edit").validate({
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('data-user-dekan.store') }}",
                    type: "POST",
                    dataType: 'json',
                    success: function (data) {
                        ...
                        $('#table_dekan').DataTable().ajax.reload(null, true);
                        Swal.fire({
                            title: 'Good job!',
    ...
    $('body').on('click', '.edit-post', function () {
        ...
        $.get('data-user-dekan/' + data_id + '/edit', function (data) {
