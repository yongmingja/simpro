...
class JabatanPegawaiSeeder extends Seeder
{
    ...
    {
        $records = [
            ['id' => '1','id_pegawai' => 1,'id_jabatan' => 1,'id_fakultas_biro' => null,'ket_jabatan' => 'Superadmin','created_at' => now(), 'updated_at' => now()],
            ['id' => '2','id_pegawai' => 1,'id_jabatan' => 2,'id_fakultas_biro' => null,'ket_jabatan' => 'Admin Umum','created_at' => now(), 'updated_at' => now()],
            ['id' => '3','id_pegawai' => 1,'id_jabatan' => 5,'id_fakultas_biro' => 2,'ket_jabatan' => 'Dekan Fakultas Komputer','created_at' => now(), 'updated_at' => now()],
            ['id' => '4','id_pegawai' => 1,'id_jabatan' => 6,'id_fakultas_biro' => null,'ket_jabatan' => 'Dosen / Staff','created_at' => now(), 'updated_at' => now()],
